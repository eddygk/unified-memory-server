...
**Neo4j Tools**:
- `get_neo4j_schema` - Retrieve graph schema
...
- `build_context` - Navigate knowledge via memory:// URLs
- `search_notes` - Search across notes
- `recent_activity` - Find recently updated items
- `canvas` - Create Obsidian canvas visualizations

**Redis Memory Tools**:
- `create_long_term_memories` - Store memories
- `search_long_term_memory` - Semantic search
- `hydrate_memory_prompt` - Get conversation context
