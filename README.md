...
This server is designed to run on a dedicated machine in your network:

- **Server IP**: User-configurable (e.g., 10.10.20.100, 192.168.1.100, or any IP in your subnet)
- **API Port**: 8000
- **MCP Port**: 9000
- **Monitoring**: Grafana on port 3000

**Note**: IP address ranges and subnets are entirely user-configurable. The examples in documentation use 10.10.20.0/24 for illustration purposes only. Configure the server to use any IP address that fits your network architecture.
...
---
[Project Documentation](https://eddygk.github.io/unified-memory-server/)
